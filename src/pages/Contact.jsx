            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#0B2545] hover:bg-[#134B70] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#134B70]"
                  >
                    Send Message
                  </button>
                </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 h-full">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-[#222222]">+91-XXXXXXXXXX</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-[#222222]">support@servicecenter.com</p>
                    </div>
                  </div>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-6">
                    <a href="#" className="text-[#134B70] hover:text-[#0B2545]">
